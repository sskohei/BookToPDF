...
const dictionaries = {
  ja: {
    ...
    "capture.exportButton": "{count}枚をPDFに書き出す",
    "capture.exporting": "PDFを生成中…",
    "capture.exportError": "PDFの生成に失敗しました。もう一度お試しください。",
  ...
  en: {
    ...
    "capture.exportButton": "Export {count} pages as PDF",
    "capture.exporting": "Generating PDF…",
    "capture.exportError": "Failed to generate the PDF. Please try again.",
    "previewGrid.pageBadge": "p.{index}",
